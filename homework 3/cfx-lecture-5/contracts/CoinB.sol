...
contract CoinB is IStandardCoin { // inheritance / implementing an interface
    string _name;
    string _symbol; // ~ CFX
    ...
    function transfer(address receiver, uint256 amount) external override {
        require(_balances[msg.sender] >= amount, "CoinB: Insufficient balance");
    ...
    function transfer2(address sender, address receiver, uint256 amount) external override {
        require(_balances[sender] >= amount, "CoinB: Insufficient balance");
